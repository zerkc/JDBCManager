...
import orz.gg.funciones.JDBCManager;
...
public class QueryBuilder<T> implements Serializable {
    ...
    private JDBCManager jdbcm = new JDBCManager();
    private Class e;
...
//    CONSTRUCTORES
     ...
     * @param query
     */
    public QueryBuilder(String query, Class e) {
        this(e);
     ...
     */
    public QueryBuilder(String query, Class e, String sentenciaFinal) {
        this(query, e);
...
//    METODOS PUBLICOS
    ...
    public List<T> ejecutarQuery(int numeroResultados) {
        prepararEjecucion();
        return jdbcm.ejecutarQuery(e, queryEjecutable, listaParametros, numeroResultados);
    }
    ...
    public List<T> ejecutarQuery(int numeroResultados, int posicionInicial) {
        prepararEjecucion();
        return (List<T>) jdbcm.ejecutarQuery(e, queryEjecutable, listaParametros, numeroResultados, posicionInicial);
    }
    ...
    public T ejecutarQuery() {
        prepararEjecucion();
        return (T) jdbcm.ejecutarQuery(e, queryEjecutable, listaParametros);
    }
...
//        prepararEjecucion();
//        return (T) jdbcm.ejecutarQuery(E.getClass(), queryEjecutable, posicionInicial, listaParametros);
//    }
    /**
     *
     * @param sentenciaFinal
